...
const zh = {
  ...
  latest: '最近一次重置', disconnected: '未连接', reading: '读取中', delayed: '更新待恢复', tracking: '追踪中',
  collectorUnavailableBadge: 'X 访问失败', collectorPartialBadge: '采集不完整',
  collectorUnavailable: '暂时无法访问 Tibo 的 X 动态，显示已保存记录；不代表没有新动态。', collectorPartial: '部分公开入口不可读，回复可能遗漏。',
  resetTime: '重置于', resetTimeUnknown: '已确认重置，具体时间待补充', noConfirmedReset: '尚无已确认的重置', awaitingConfirmedReset: '确认发放后，这里会显示最近一次重置。',
  just: '刚刚', justDetail: '额度刚刚重置', minutesAgo: '分钟前', hoursAgo: '小时前', daysAgo: '天前', announcedAt: '重置于 {time}', hoursSince: '距重置已过 {hours} 小时 {minutes} 分钟', daysSince: '距重置已过 {days} 天 {hours} 小时',
  ...
  officialAccountLabel: '微信公众号', officialAccountCodeAlt: '微信公众号二维码', officialAccountEnlarge: '查看公众号二维码大图', officialAccountScan: '微信扫一扫，关注公众号。',
} as const;
...
const en: Record<MessageKey, string> = {
  ...
  latest: 'LATEST RESET', disconnected: 'Offline', reading: 'Loading', delayed: 'Update delayed', tracking: 'Tracking',
  collectorUnavailableBadge: 'X unavailable', collectorPartialBadge: 'Partial coverage',
  collectorUnavailable: 'Tibo’s X activity is temporarily unavailable. Saved records are shown; this does not mean there are no new posts.', collectorPartial: 'Some public sources are unavailable. Replies may be missing.',
  resetTime: 'Reset at', resetTimeUnknown: 'Reset confirmed; exact time not yet recorded', noConfirmedReset: 'No confirmed reset yet', awaitingConfirmedReset: 'The latest reset will appear here once delivery is confirmed.',
  just: 'Just', justDetail: 'Limits just reset', minutesAgo: 'minutes ago', hoursAgo: 'hours ago', daysAgo: 'days ago', announcedAt: 'Reset at {time}', hoursSince: '{hours}h {minutes}m since the reset', daysSince: '{days}d {hours}h since the reset',
  ...
  officialAccountLabel: 'WECHAT OFFICIAL ACCOUNT', officialAccountCodeAlt: 'WeChat official account QR code', officialAccountEnlarge: 'View larger account QR code', officialAccountScan: 'Scan with WeChat to follow the official account.',
};
