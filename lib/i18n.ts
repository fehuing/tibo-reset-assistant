...
const zh = {
  ...
  loadingTitle: '正在读取最新重置记录', failedTitle: '暂时连不上数据源', loadingText: '每一次好消息，都值得记下来。', failedText: '稍后再试，确认后的记录会显示在这里。', checkedAt: '检查于 {time} · 每 2 分钟更新', waitingFirst: '等待首次成功更新', checking: '检查中', checkUpdates: '检查更新', staleCached: '当前显示上次成功取得的记录。数据暂未更新，不代表没有新公告。', unavailable: '数据暂时不可用，请点击“检查更新”重试。', sourceDirect: 'X 公开动态直采', sourceFallback: '备用接口',
